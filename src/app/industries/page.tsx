      ...
      <Container>
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            tailored solutions that understand your sector&apos;s unique
            ...
            {[
              {
                ...
                result:
                  "Delivered 18 qualified candidates, 15 hired within timeline",
                icon: FiMonitor,
                color: "text-blue-400",
              },
              {
                ...
                result:
                  "Placed experienced CFO who increased efficiency by 40%",
                icon: FiDollarSign,
              ...
              },
              {
                ...
                result:
                  "Built complete sales organization, 200% revenue growth",
                icon: FiTrendingUp,
        ...
        <Container>
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-white text-center">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Let us connect you with top-tier professionals who understand your
