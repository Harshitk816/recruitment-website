      ...
      <div className="bg-gradient-to-br from-green-600 via-emerald-600 to-teal-700 rounded-3xl p-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 grid md:grid-cols-5 gap-8 items-center">
          ...
          <div className="md:col-span-3 space-y-6 order-1 md:order-2">
            ...
            <div>
              <h3 className="text-4xl font-bold mb-2">{name}</h3>
              <p className="text-xl text-emerald-200 font-medium mb-4">
                {title}
              </p>
              <p className="text-white/90 leading-relaxed text-lg">
                {description}
...
export const About: React.FC = () => {
  ...
  return (
    <section
      id="about"
      className="py-20 bg-gradient-to-b from-white via-gray-50 to-blue-50"
    >
      <Container>
        {/* Enhanced Header */}
        <motion.div
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            The <span className="text-blue-600">Visionaries</span> Behind
            Workeraa
          </h2>

          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Two passionate leaders united by a common vision: revolutionizing
            how exceptional talent connects with innovative companies across
            India and beyond.
          </p>
        </motion.div>
        ...
        <div className="space-y-16 mb-20">
          <FounderCardSecondary {...foundersData[0]} />{" "}
          {/* Alisha (Green card) */}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Partnership",
                description:
                  "Collaborative approach focused on long-term success",
              ...
              },
              {
                ...
                title: "Innovation",
                description:
                  "Embracing modern recruitment strategies and technology",
